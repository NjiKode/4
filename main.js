...
global.backupdb = async () => {
  let o
  try {
    o = await execrl(`git checkout db && git add database.json && git commit -am "Updating Database" && git push -f https://PencariKode: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@github.com/PencariKode/nwbot.git`)
  } catch (e) {
    o = e
  } finally {
    console.log(o);
