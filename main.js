...
global.backupdb = async () => {
  let o
  try {
    o = await execrl(`git checkout db && git add database.json && git commit -m "Updating Database" && git push -f https://PanjiGTPS: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@github.com/PanjiGTPS/nwbot.git`)
  } catch (e) {
    o = e
  } finally {
    console.log(o);
