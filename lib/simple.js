        ...
        reply: {
            ...
            value(jid, text = '', quoted, options) {
              ...
              options = options ? options : {...options, mentions: conn.parseMention(text)}
                return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { mentions: conn.parseMention(text), ...options, text, mentions: conn.parseMention(text), }, { quoted, ...options })
            }
        },
        sendButton: {
            /**
